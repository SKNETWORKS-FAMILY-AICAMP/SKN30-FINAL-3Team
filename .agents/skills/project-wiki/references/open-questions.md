...
OQ-CHAT-01·02는 2026-09-08 사용자 설계 합의로 해소했다. [F4 챗봇 요구사항](../../../../docs/requirements/chatbot/overview-and-scope.md), [저장 설계](../../../../docs/architecture/chatbot/persistence.md), [대화 보존 정책](privacy/policy.md)에 반영했으며 구현은 미착수·팀 병합 검토 전이다.
