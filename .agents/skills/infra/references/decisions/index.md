...
| [ADR-0024](ADR-0024-shared-serving-selection-lifecycle.md) | 기반 병합·2026-09-11 AWS F2/general 전체 앱 기동·직접 검증 완료·팀 변경 검토 대기 | 공유 선택 기반 계획·Template API 조정·maintenance·실패 정리·검증 인계 |
