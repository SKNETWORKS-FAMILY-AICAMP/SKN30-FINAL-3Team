...
| INFRA-OQ-010 | Versioned Terraform state bucket의 비운영자 Deny에 `GetObjectVersion`·`DeleteObjectVersion`·`ListBucketVersions`를 언제 추가하고 policy change를 적용할 것인가? | 이전 state version 기밀성·무결성 | 해결: 2026-09-09 사용자 승인 후 적용·AWS 대조·drift 없음 확인 |
