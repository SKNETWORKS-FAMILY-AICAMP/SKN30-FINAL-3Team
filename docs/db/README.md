...
| seed/ | 로컬·데모용 합성 장부 데이터 | 수동 적용 · 운영 제외 |

seed/의 파일은 migration이 아니다. 실행기가 적용 여부를 관리하지 않고 번호도 migrate/와 무관하며 운영 환경에 적용하지 않는다. 상세는 [seed/README.md](seed/README.md)에 있다.
