...
| [캘린더 (폐기)](f4/calendar.md) | `F4-CAL`, 2026-09-08 사용자 요청으로 전체 폐기. 과거 구현 추적용으로만 보존 |
| [제외·미착수·미해결](f4/scope-and-open-questions.md) | 뉴스·문자 초안·블로그 초안의 미착수 사유, F4 제외 범위 |

F4의 Time Keeper는 구현됐다. 캘린더는 구현됐다가 2026-09-08 폐기됐다. 업무 챗봇은 사용자 설계 합의·구현 미착수이며 아래 문서가 정본이다. 뉴스·문자 초안·블로그 초안은 설계 전이므로 상세 문서를 미리 만들지 않는다.
